...
import TreeController from './tree.ctrl';
import TreeComponent from './tree.comp';
import TreeTemplate from './tree.html';

describe('Tree', () => {
    let $rootScope, makeController;

    beforeEach(window.module(TreeModule.name));
    ...
    describe('Template', () => {
        ...
        it('has name in template [REMOVE]', () => {
            expect(TreeTemplate).to.match(/{{\s?vm\.name\s?}}/g);
        });
    });
